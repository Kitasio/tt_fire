        ...
        <div class="p-4 w-full h-full md:p-6 flex justify-between flex-col overflow-y-scroll">
            <div>
                ...
                <div class="space-y-3 md:space-y-6">
                    <input class="border-b focus:outline-none text-xl border-black w-full" type="text" placeholder="Name" required>
                    <input class="border-b focus:outline-none text-xl border-black w-full" type="email" placeholder="Email" required>
                    <input class="border-b focus:outline-none text-xl border-black w-full" type="text" placeholder="Telegram, Whatsapp, etc...">
                    <textarea class="border-b transition-all duration-700 h-8 focus:h-32 focus:outline-none text-xl border-black w-full" id="txt" name="request" rows="1" placeholder="Describe your request..."></textarea>
                </div>
            </div>
